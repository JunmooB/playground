...
try:
    ...
    # numbers_as_str = [str(i).zfill(4) for i in range(418, 498)]
    ...
    # error_resulsts = []
    # numbers = [str(num) for num in range(2039, 2501)]
    ...
    # for temp in temps:
    #     image_file_list.append(str(temp)) 
    # res_temps = [str(num) for num in range(2288, 2301)]

    # # numbers = ['2002', '2003', '2015', '2017', '2021', '2025', '2028', '2032']
    # numbers = []
    # for res_temp in res_temps:
    #     if res_temp not in image_file_list:
    #         numbers.append(res_temp)
    
    numbers = ['1058', '1059', '1181', '1183', '1339', '1345']
